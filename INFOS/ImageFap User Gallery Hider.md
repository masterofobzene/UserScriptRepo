### USE CASE:
--------------
You can now filter stuff you don't want to see from specified users. This userscript will hide all their content 
...
if they uploaded more stuff, you will not see them again and all in one click!
...
UPDATE 2.4: Fixed regression due to matching all pages in the domain.
