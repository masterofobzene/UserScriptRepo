...
(function() {
    ...
    function highlightDimensions(container = document) {
    ...
    // React to paginated content
    window.addEventListener('imagefap:page-loaded', e => {
        if (e.detail?.wrapper) {
            highlightDimensions(e.detail.wrapper);
        }
    });
})();
